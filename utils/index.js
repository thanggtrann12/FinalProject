...
const dbHumi = firebase.database().ref().child("DỮ LIỆU/NHIỆT ĐỘ");
const temparute = document.getElementById("temp");
const dbTemp = firebase.database().ref().child("DỮ LIỆU/ĐỘ ẨM");
...
function toggleCheckbox(element) {
    ...
    if (element.checked) {
        ...
        firebase.database().ref(element.id.toString()).set({ Status: "Off" });
}
